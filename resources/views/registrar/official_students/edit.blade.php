<x-registrar_sidebar>
    ...
    <div class="flex items-center gap-4 mb-6">
        <a href="{{ route('registrar.official_students') }}" class="btn btn-ghost btn-sm">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clip-rule="evenodd" />
            </svg>
            Back
        </a>
        <h2 class="font-bold text-4xl flex-1">Edit Official Student</h2>
    </div>

    <form action="{{ route('registrar.official_students.update', $student->id) }}" method="POST">
        @csrf
        ...
        <div class="flex justify-end gap-4">
            <a href="{{ route('registrar.official_students') }}" class="btn btn-ghost">Cancel</a>
