      ...
      <div class="drawer-side is-drawer-close:overflow-visible">
        ...
        <div class="flex h-screen flex-col items-start bg-white shadow is-drawer-close:w-14 is-drawer-open:w-64 overflow-hidden">
          ...
          <ul class="menu w-full grow overflow-y-auto min-h-0">
            <!-- Dashboard -->
            <li>
              <a href="{{ route('department.dashboard') }}" class="is-drawer-close:tooltip my-2 is-drawer-close:tooltip-right {{ request()->routeIs('department.dashboard') ? 'bg-black text-white' : '' }}" data-tip="Dashboard">
                <!-- Home icon -->
            ...
            <!-- List item -->
            <li>
              <a href="{{ route('department.student') }}" class="is-drawer-close:tooltip my-2 is-drawer-close:tooltip-right {{ request()->routeIs('department.student*') ? 'bg-black text-white' : '' }}" data-tip="Students">
                <!-- Academic Cap icon -->
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
            ...
            <li>
              <a href="{{ route('department.enlistment') }}" class="is-drawer-close:tooltip my-2 is-drawer-close:tooltip-right {{ request()->routeIs('department.enlistment*') ? 'bg-black text-white' : '' }}" data-tip="Enlistment"
            ...
            <!-- List item -->
            <li>
              <a href="{{ route('department.subject_offering') }}" class="is-drawer-close:tooltip my-2 is-drawer-close:tooltip-right {{ request()->routeIs('department.subject_offering*') ? 'bg-black text-white' : '' }}" data-tip="Subject Offering"
            ...
            <li>
              <a href="{{ route('department.grading_components.index') }}" class="is-drawer-close:tooltip my-2 is-drawer-close:tooltip-right {{ request()->routeIs('department.grading_components*') ? 'bg-black text-white' : '' }}" data-tip="Grading Components">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
            ...
            <li>
              <a href="{{ route('department.grading_systems.index') }}" class="is-drawer-close:tooltip my-2 is-drawer-close:tooltip-right {{ request()->routeIs('department.grading_systems*') ? 'bg-black text-white' : '' }}" data-tip="Grading Systems">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
            ...
            <li>
              <a href="{{ route('department.grade_report') }}" class="is-drawer-close:tooltip my-2 is-drawer-close:tooltip-right {{ request()->routeIs('department.grade_report*') ? 'bg-black text-white' : '' }}" data-tip="Grade Report">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
            ...
            <li>
              <a href="{{ route('department.teacher_loading') }}" class="is-drawer-close:tooltip my-2 is-drawer-close:tooltip-right {{ request()->routeIs('department.teacher_loading*') ? 'bg-black text-white' : '' }}" data-tip="Teacher Loading">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
                </svg>
                <span class="is-drawer-close:hidden">Teacher Loading</span>
              </a>
            </li>
          </ul>
          ...
          <div class="flex items-center justify-between gap-2 px-2 py-2">
            ...
            <form action="{{ route('department.logout') }}" method="POST" class="w-full is-drawer-open:w-auto">
              @csrf
