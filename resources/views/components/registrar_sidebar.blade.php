      ...
      <div class="drawer-side is-drawer-close:overflow-visible">
        ...
        <div class="flex min-h-full flex-col items-start bg-white shadow is-drawer-close:w-14 is-drawer-open:w-64">
          ...
          <ul class="menu w-full grow">
            ...
            <li>
              <a href="{{ route('registrar.teacher') }}" class="is-drawer-close:tooltip my-2 is-drawer-close:tooltip-right" data-tip="Teachers">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
            ...
            <li>
              <a href="{{ route('registrar.grade_approval') }}" class="is-drawer-close:tooltip my-2 is-drawer-close:tooltip-right" data-tip="Grade Approval">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
            ...
            <li>
              <a href="{{ route('registrar.grade_report') }}" class="is-drawer-close:tooltip my-2 is-drawer-close:tooltip-right" data-tip="Grade Report">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
            ...
            <!-- List item -->
            <li>
              <a href="{{ route('registrar.classlist') }}" class="is-drawer-close:tooltip my-2 is-drawer-close:tooltip-right" data-tip="Class List">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
