<x-student_portal_sidebar>
    ...
    <div class="flex items-center gap-4 mb-4">
        <h2 class="font-bold text-4xl flex-1">Enrolled Subjects</h2>
    ...
    @elseif (!isset($academicTerm) || !$academicTerm)
        <div class="alert bg-blue-400 text-white">
            <span>Please select an academic term to view your enrolled subjects.</span>
        </div>
    @else
            ...
            <div class="overflow-x-auto">
                <table class="table table-zebra table-sm">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center text-gray-500 py-4">No enrolled subjects for this academic term.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
