...
-- Dumping database structure for uca-nexus59
...
-- Dumping data for table uca-nexus.components: ~6 rows (approximately)
...
-- Dumping data for table uca-nexus.departments: ~4 rows (approximately)
...
-- Dumping data for table uca-nexus.enlistments: ~3 rows (approximately)
...
-- Dumping data for table uca-nexus.levels: ~21 rows (approximately)
...
-- Dumping data for table uca-nexus.migrations: ~49 rows (approximately)
...
-- Dumping data for table uca-nexus.prospectuses: ~15 rows (approximately)
...
-- Dumping data for table uca-nexus.sessions: ~2 rows (approximately)
REPLACE INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('c8cjnfpJB2ERfR1Cyk9fV0BZrUuC3cFgZiKjEALt', 2, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36', '', 1777687604),
	('Fyex3gHCb7m2J0ln8oVaSibcTOOzY52pBoM3Myq9', 2, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36', '', 1777712364);
...
-- Dumping data for table uca-nexus.student_academic_histories: ~10 rows (approximately)
...
-- Dumping data for table uca-nexus.student_contacts: ~10 rows (approximately)
